...
const Register = () => {
    ...
    const [userState, setuserState] = useState(user); //User Input State
    const [errorState, seterrorState] = useState(errors); //Error State
    const [isLoading, setIsLoading] = useState(false); //Loading Button State
    ...
    //validating input function checks
    const checkForm = () => {
        if (isFormEmpty()) {
    ...
    //Password length and confirm Password value
    const checkPassword = () => {
    ...
    //Adding display name and photoURL for Avatar
    ...
    //Saving Data(Name,photURL) in Firebase Realtime
